...
insert into actor (id, username, password, stream, email, role_id) values (1, 'MrKrabs', '$2a$12$1cCtxxzFxebta4O8vii.Bekfvz0EycWqdO6PIKyf.22R0i3VobbH6', '', 'mrkrabs@teachers.com', 1);
insert into actor (id, username, password, stream, email, role_id) values (2, 'Spongebob', '$2a$12$JfKtqN42hoTKoBend.wo3uTV4HQUAFhMuwWYIKD7uyxaT9vTYwbYq', 'FRONTEND', 'spongy@teachers.com', 2);
